...
//import './index.css'
import {startGame as sneakersGameDemo} from './games/sneakersGameDemo.js'
import {initScenePipelineModule} from './threejs-scene-init-sneakers.js'
...
const launchGame = (vps,module,wayspotId) => {
  ...
  if(vps){
    ...
    XR8.addCameraPipelineModule(initScenePipelineModule())
    XR8.addCameraPipelineModule(module(UI,window.CoachingOverlay,vps))
  }
...
const onxrloaded = () => {
  ...
  $( document ).ready(function() {
    ...
    $('#quest-single > a').on('touchstart', function (e) {
      ...
      launchGame(false,sneakersGameDemo)
    })
    ...
    */
    ...
    $('#quest-single > a').trigger('touchstart')
